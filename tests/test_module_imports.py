...
def _module_needs_optional_dep(module_path: str) -> bool:
    modules_that_need_optional = {
        "brain_system.dlcs",
        "brain_system.dlcs.brain_dlc_nn",
        "brain_system.dlcs.brain_dlc_workflow",
        "brain_system.dlcs.brain_dlc_hardware",
        "brain_system.dlcs.brain_dlc_distributed",
        "dlcs",
        ...
        "mca_core.ui.dpi_awareness",
        "mca_core.ui.components.main_notebook",
        "mca_core.app_graph_mixin",
        "mca_core.app_initialization_mixin",
        "mca_core.app_ui_mixin",
        "mca_core.app",
        "mca_core.lab_mixins",
        "mca_core.ui.components.menu_bar",
        "mca_core.ui.components.log_view",
        "mca_core.ui.components.toolbar",
        "mca_core.ui.components.brain_monitor",
        "brain_system.ui",
